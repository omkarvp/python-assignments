...
from Assignment15_Module import DisplayModule,lambdaMaximumNumberModule

MaximumNumber = lambda Num1, Num2 : max(Num1, Num2)
...
def main():
    ...
    Ret = reduce(lambdaMaximumNumberModule,Arr)
